...
const Hero = () => {
  ...
  return <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20" aria-labelledby="hero-heading" itemScope itemType="https://schema.org/WebPageElement">
      <StarBackground />
      
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          <header>
            <h1 id="hero-heading" className="text-4xl sm:text-5xl md:text-6xl font-bold mb-4 cyber-text-3d animate-fade-in" itemProp="headline">
          ...
          animationDelay: '0.4s'
            ...
            <a href="https://chatgpt.com/g/g-8t4uyWOrI-ai-tools-expert-finder-gpt" target="_blank" rel="noopener noreferrer" className="cyber-button w-full md:w-auto" aria-label="Use AI Tools Expert & Finder GPT - Best AI Tools Finder">
          ...
          <aside className="mt-16 animate-fade-in" style={{
          animationDelay: '0.6s'
        }}>
            ...
            <figure className="mb-8 rounded-lg overflow-hidden glass-panel transition-all duration-300 hover:shadow-lg hover:shadow-cyber-neon-blue/20" itemScope itemType="https://schema.org/VideoObject">
              ...
              <iframe width="560" height="315" src="https://www.youtube.com/embed/p3czNalrf8c?autoplay=1&mute=0&controls=1&showinfo=0&rel=0&vq=hd1080&iv_load_policy=3" title="AI Tools Expert & Finder GPT Demo - Find Best Free AI Tools 2025 | AIWebTools.AI" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen className="w-full aspect-video max-w-3xl mx-auto" loading="lazy"></iframe>
            </figure>
          </aside>
          
          {showScrollHint && <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 cursor-pointer animate-bounce" onClick={scrollToFeatures}>
