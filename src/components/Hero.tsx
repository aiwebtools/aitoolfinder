      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          animationDelay: '0.4s'
            ...
            <a href="https://www.aiwebtools.ai" target="_blank" rel="noopener noreferrer" className="cyber-button-outline w-full md:w-auto">EXPLORE OUR FULL AI TOOL SELECTION</a>
          </div>
          ...
          animationDelay: '0.6s'
            ...
            <a href="https://docs.google.com/document/d/1qtDKo3XN_EsspgrQD72Cpq2qh83H5xSd/edit?usp=drivesdk&ouid=116187507271950139405&rtpof=true&sd=true" target="_blank" rel="noopener noreferrer" className="inline-block mb-8 rounded-lg overflow-hidden glass-panel p-2 transition-all duration-300 hover:shadow-lg hover:shadow-cyber-neon-blue/20">
              <img src="https://img1.wsimg.com/isteam/ip/9fd6d942-5b46-4025-92e2-0f1ec2a7adf2/blob-aab53a2.png/:/cr=t:0%25,l:0%25,w:100%25,h:100%25/rs=w:1152,cg:true" alt="AI Tools Collection" className="w-full max-w-xs mx-auto rounded shadow-lg" loading="lazy" />
            </a>
          </div>
