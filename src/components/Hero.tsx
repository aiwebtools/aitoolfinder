...
const Hero = () => {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-16 sm:pt-20" aria-labelledby="hero-heading" itemScope itemType="https://schema.org/WebPageElement">
      <StarBackground />
      
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          <header>
            <h1 id="hero-heading" className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-3 sm:mb-4 cyber-text-3d animate-fade-in" itemProp="headline">
              <span className="cyber-gradient-text">AI Tools Expert & Finder GPT</span>
            </h1>
            
            <p className="text-base sm:text-xl md:text-2xl text-white/80 mb-6 sm:mb-8 animate-fade-in px-2" style={{
              animationDelay: '0.2s'
          ...
          <div className="space-y-3 sm:space-y-4 md:space-y-0 md:space-x-4 flex flex-col md:flex-row justify-center items-center animate-fade-in px-2" style={{
            animationDelay: '0.4s'
          }}>
            <a href="https://chatgpt.com/g/g-8t4uyWOrI-ai-tools-expert-finder-gpt" target="_blank" rel="noopener noreferrer" className="cyber-button w-full md:w-auto text-sm sm:text-base" aria-label="Use AI Tools Expert & Finder GPT - Best AI Tools Finder">
              USE AI TOOLS EXPERT & FINDER GPT NOW
            </a>
            
            <a href="https://aiwebtools.lovable.app/?via=aiwebtools" target="_blank" rel="noopener noreferrer" className="cyber-button-outline w-full md:w-auto text-sm sm:text-base" aria-label="Explore AI Web Tools - Free AI Tools Directory">
              EXPLORE OUR FULL AI TOOL SELECTION
            </a>
          </div>
          
          <aside className="mt-10 sm:mt-16 animate-fade-in" style={{
            animationDelay: '0.6s'
          }}>
            <p className="text-white/60 mb-3 text-sm sm:text-base">
            ...
            <figure className="mb-8 rounded-lg overflow-hidden glass-panel transition-all duration-300 hover:shadow-lg hover:shadow-cyber-neon-blue/20" itemScope itemType="https://schema.org/VideoObject">
          ...
          {showScrollHint && (
            <div className="absolute bottom-6 sm:bottom-8 left-1/2 transform -translate-x-1/2 cursor-pointer animate-bounce" onClick={scrollToFeatures}>
              <ChevronDown className="h-6 w-6 sm:h-8 sm:w-8 text-cyber-neon-blue" />
            </div>
          )}
        </div>
      </div>
